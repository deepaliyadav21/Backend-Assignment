...
//     let result = new agent(req.body);
//     let data = await result.save();
//     res.send(data);
// }

// exports.orderItem = async(req,res)=>{
//     let result = new order(req.body);
//     let data = await result.save();
//     res.send(data);
// }
...
//     const { id } = req.params;
//     let result = await order.find({userId:id,status:"pending"});
//     console.log(result)
//     res.send(result);
// }
...
//       await orderDoc.save();
//       console.log("Order updated:", orderDoc);
...
//       console.log("Agent alloted:", allotedAgent);
...
//             console.log("Agent is now available:", deliveryAgent);
//           }
//         } catch (error) {
//           console.error("Error during delayed delivery update:", error.message);
//         }
//       }, 10000);
  
//       res.status(200).json({ message: "Order approved and out for delivery", order: orderDoc, agent: allotedAgent });
